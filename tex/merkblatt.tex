...
\subsection{Substitution}
	...
	Vorgehen: Wir setzen $u$ gleich einem Wert, sodass die ableitung $\d u$ einen Teil unserer Ableitung ersetzen kann. Wir ersetzen sowohl $\d x$ als auch (sofern vorhanden) die Grenzen. Nun fahren wir normal mit der Auswertung fort.
...
$$
	\int \arcsin \frac{x}{a} \, \d x = x \arcsin \frac{x}{a} + \sqrt{a^2 - x^2}  
$$
